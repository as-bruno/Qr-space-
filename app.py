...
if __name__ == "__main__":
    # --- SETTINGS ---
    # Target file size in MB. Files already under this size won't be compressed.
    TARGET_SIZE_MB = 1.0
    # Maximum width in pixels. Images larger than this will be resized (e.g., 3840 for 4K).
    MAX_WIDTH = 3840
    # ----------------
    ...
    if not os.path.exists(input_dir):
        ...
        print("[*] Please place your images inside the 'input' folder and run the script again.")
        sys.exit(0)
    ...
    if os.path.exists(input_dir):
        ...
        images_found = [f for f in files if f.lower().endswith(image_extensions)]
        ...
        if not images_found:
            ...
            print(f"[*] Target size: {TARGET_SIZE_MB}MB | Max width: {MAX_WIDTH}px")
            print(f"{'='*70}\n")
            ...
            with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
                ...
                for filename in images_found:
                    ...
                    futures.append(executor.submit(compress_image, input_path, output_path, TARGET_SIZE_MB, MAX_WIDTH))
