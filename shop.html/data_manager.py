...
# Use the same persistent storage path as defined in app.py
PERSISTENT_STORAGE_PATH = os.environ.get('RENDER_DISK_PATH', 'persistent_data')
DATABASE_PATH = os.path.join(PERSISTENT_STORAGE_PATH, 'products.json')
# --- NEW: Define a lock file to prevent race conditions when writing to products.json ---
LOCK_FILE = os.path.join(PERSISTENT_STORAGE_PATH, 'products.json.lock')
